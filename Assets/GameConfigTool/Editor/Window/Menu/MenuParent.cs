...
namespace GCT.Window
{
	...
	{
		protected GCTWindow m_parentWindow = null;
		...
		public MenuParent( GCTWindow parentWindow, float x, float y, float width, float height, string name, MenuAnchor anchor = MenuAnchor.NONE, MenuAutoSize autoSize = MenuAutoSize.NONE )
		{
		...
		public GCTWindow ParentWindow { get { return m_parentWindow; } set { m_parentWindow = value; } }
	}
}
